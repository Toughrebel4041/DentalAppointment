...
<div>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img
        src="https://d1csarkz8obe9u.cloudfront.net/posterpreviews/dental-tumblr-banner-design-template-89c87525733b1f86b009ad8ab854471a_screen.jpg?ts=1633966272"
        class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      ...
      <div class="row grid justify-content-center gap-3">
        <div class="card col-sm-4" style="width: 27.86rem;">
          ...
          <div class="card-body">
            ...
            <img
              src="https://d1vbn70lmn1nqe.cloudfront.net/prod/wp-content/uploads/2023/08/29043653/kategori-Bleaching-Gigi.jpg"
        ...
        <div class="card col-sm-4" style="width: 27.86rem;">
          ...
          <div class="card-body">
            ...
            <img
              src="https://res.cloudinary.com/dk0z4ums3/image/upload/v1611295592/attached_image/veneer-gigi-ini-yang-harus-anda-ketahui.jpg"
              class="img-thumbnail" alt="...">
        ...
        <div class="card col-sm-4" style="width: 27.86rem;">
          ...
          <div class="card-body">
            ...
            <img
              src="https://platinumdental.com.my/wp-content/uploads/elementor/thumbs/image8-pbhlm6sk5pea15vdn6doqkfhz47p6ilvith1klbe0o.jpg"
              class="img-thumbnail" alt="...">
        ...
        <div class="card col-sm-4" style="width: 27.86rem;">
          ...
          <div class="card-body">
            ...
            <img
              src="https://res.cloudinary.com/dk0z4ums3/image/upload/v1668053492/attached_image/ketahui-apa-itu-scaling-gigi.jpg"
              class="img-thumbnail" alt="...">
        ...
        <div class="card col-sm-4" style="width: 27.86rem;">
          ...
          <div class="card-body">
            ...
            <img
              src="https://static.hdmall.id/system/image_attachments/images/000/041/332/original/shutterstock_417290032.jpg"
              class="img-thumbnail" alt="...">
...
<div class="row row-cols-1 row-cols-md-3 g-4 mx-3 mb-3">
  <div class="col">
    <div class="card h-100">
      <img src="http://klinikjoydental.com/wp-content/uploads/2014/05/tambal-gigi-depan-by-GJP.jpg" class="card-img-top img-fluid" alt="Tambal Gigi Patah">
      <div class="card-body">
        <h5 class="card-title">Tambal Gigi Patah</h5>
        <p class="card-text">Gigi patah bisa diperbaiki kembali dengan rapih agar senyumanmu terbit kembali!</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img src="https://i.ytimg.com/vi/2NZKJb8cia4/maxresdefault.jpg" class="card-img-top img-fluid" alt="Scalling Gigi">
      <div class="card-body">
        <h5 class="card-title">Scaling Gigi</h5>
        <p class="card-text">Yuk lakukan scaling gigi rutin setiap 6 bulan sekali, jangan biarkan kotoran menumpuk di gigimu!</p>
      </div>
    </div>
  </div>
  <div class="col">
    <div class="card h-100">
      <img src="https://i.ytimg.com/vi/C1cRa9SBQGk/maxresdefault.jpg" class="card-img-top img-fluid" alt="Veneer Gigi">
      <div class="card-body">
        <h5 class="card-title">Veneer Gigi</h5>
        <p class="card-text">Gigi kusam dan tidak pede? Veneer solusinya! <br> Kilaukan senyuman terbaikmu setiap hari berkat Veneer di SSR Dental Clinic!</p>
      </div>
    </div>
  </div>
</div>
