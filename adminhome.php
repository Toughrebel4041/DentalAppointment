...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="adminhome.php?p=home">Home</a>
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="adminhome.php?p=profile">Profile</a></li>
                <li><a class="dropdown-item" href="adminhome.php?p=dentistprofile">Dentist</a></li>
                <li><a class="dropdown-item" href="adminhome.php?p=facilities">Facilities</a></li>
                <li><a class="dropdown-item" href="adminhome.php?p=contact">Contact Us</a></li>
              </ul>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="adminhome.php?p=treatment">Treatments</a>
            </li>
            <li class="nav-item">
